...
/**
 * The AccessibilityNotification is the object passed to your selecter or
 * notification handler from a AccessibilityObserver.
 *
 * You shouldn't use this directly.
 *
 * @see AccessibilityObserver
 */
@interface AccessibilityNotification : NSObject {
