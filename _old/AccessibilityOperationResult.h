...
/**
 * The AccessibilityOperationResult is a result object from an accessibility
 * operation performed by the AccessibilityManager.
 *
 ...
 *
 * @code
 * accessManager = [AccessibilityManager sharedInstance];
 ...
 * AccessibilityOperationResult * windowres;
 * AccessibilityOperationResult * pidres = [accessManager applicationRefFromPid:appid];
 ...
 *
 */
@interface AccessibilityOperationResult : NSObject {
